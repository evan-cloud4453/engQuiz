...
const partsInfo = [
    {
        ...
        questions: [
            ...
            { q: "waive", options: ["(A) 실시하다", "(B) (권리·요금 등을) 포기하다", "(C) 할당하다", "(D) 상의하다"], answer: "(B) (권리·요금 등을) 포기하다" },
            { q: "streamline", options: ["(A) 환불하다", "(B) 간소화하다, 능률적으로 하다", "(C) 초과하다", "(D) 위임하다"], answer: "(B) 간소화하다, 능률적으로 하다" },
            ...
            { q: "outpace", options: ["(A) 앞지르다, 능가하다", "(B) 지탱하다", "(C) 번창하다", "(D) 방해하다"], answer: "(A) 앞지르다, 능가하다" },
            { q: "forestall", options: ["(A) 수용하다", "(B) 교체하다", "(C) 처리하다", "(D) 미연에 방지하다"], answer: "(D) 미연에 방지하다" },
    ...
    },
    {
        ...
        questions: [
            ...
            { q: "Wyncote Airlines has announced that it will w----- the £15 baggage fee.\n(해석: 윈코트 항공은 15파운드 수하물 요금을 면제할 것이라고 발표했습니다.)", answer: "waive" },
            ...
            { q: "Dr. Okada has received the p----- Lowery Award.\n(해석: 오카다 박사는 제약 연구 부문에서 명성 있는 로워리 상을 받았습니다.)", answer: "prestigious" },
            ...
            { q: "The accountant i----- made a mistake while entering the data.\n(해석: 그 회계사는 데이터를 입력하는 동안 무심코 실수를 저질렀습니다.)", answer: "inadvertently" },
